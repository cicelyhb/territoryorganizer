...
<html lang = "en">
    <head>
        ...
        <title>Territory Organizer:Create Territory</title>
...
<!--        <a href="#" class="closebtn" >&times;</a>-->
        ...
        <div id= "mytoolbox" class="toolbox" style="display:block;">
        <script src="scripts/menu.js"></script> 
    ...
    function geocodePosition(pos) {
      ...
      function(results, status) {
       if (status === google.maps.GeocoderStatus.OK) { 
        var html = '<table><tr><td><h3><p><b>' + results[0].formatted_address + '</h3></p></b></td></tr></table>' +
