...
$checkinguid = $_GET['checkinguid'];
$responseusername = $_GET['responseusername'];
...
//Build query
$tsql = "call assignTerritory('$checkinguid','$congregationnumber','$territorynumber','$responseusername','$responsedate')";
