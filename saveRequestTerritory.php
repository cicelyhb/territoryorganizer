...
$requestusername = $_GET['requestusername'];
$groupguid = $_GET['groupguid'];
...
//Build query
$tsql = "call requestTerritory('$congregationnumber','$territorynumber','$requestusername','$groupguid','$requestdate')";
