...
//Build query
if ($bunit == 0 && $bmulti == 0 ){
    $tsql = "call addterritoryaddress('$congregationnumber',
                                      '$territorynumber',
                                      '$placeid',
                                      '$latitude',
                                      '$longitude', 
...
if ($bunit == 1){
    $tsql = "call addterritoryaddressUnit('$congregationnumber',
                                          '$territorynumber',
                                          '$placeid',
                                          '$latitude',
                                          '$longitude', 
...
if ($bmulti == 1){
    $tsql = "call addterritoryaddressMulti('$congregationnumber',
                                           '$territorynumber',
                                           '$placeid',
                                           '$latitude',
                                           '$longitude', 
