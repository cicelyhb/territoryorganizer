...
//Build query
    ...
    $tsql = "call getterritoryinfo('$congregationnumber','$territorynumber')";
...
{
  $data[] = array("Center" => $row[0], "Rectangle" => $row[1], "Compass" => $row[2], "Zoom" => $row[3], "Polygon" => $row[4], "Properties" => $row[5], "DefaultView" => $row[6]);
}
